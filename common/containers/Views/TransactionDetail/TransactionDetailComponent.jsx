...
import {formatDITColumns, formatAmountFromData, buildColumnFromObject, makeDataWithExcludedPropertiesAndFilterBasedOnProperties} from "utils/tableHelpers";
...
export default class TransactionDetailComponent extends Component {
    ...
    componentDidMount() {
        ...
        searchBlockchain(transactionHash).then((data) => {
            ...
            nextState.otherColumns = formatDITColumns(buildColumnFromObject(nextState.data, [], customRender))
            nextState.otherData = formatAmountFromData(makeDataWithExcludedPropertiesAndFilterBasedOnProperties([nextState.data]))

            nextState.outputsColumns = formatDITColumns(buildColumnFromObject(nextState.data.outputs[0], [], otherCustomRender))
            ...
            nextState.inputsColumns = nextState.data.inputs ? formatDITColumns(buildColumnFromObject(nextState.data.inputs[0], [], otherCustomRender)) : []
