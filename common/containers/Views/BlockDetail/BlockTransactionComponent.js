...
export default class BlockTransactionComponent extends Component {
    ...
    executeStateTransform(propsBlock) {
        ...
        if (propsBlock) {
            ...
            nextState.columns = formatDITColumns(buildColumnFromObject(nextState.block.txs[0], ["coinbase", "payment_id8"], customTransactionColumn))
            ...
            nextState.coinbaseColumns = formatDITColumns(buildColumnFromObject(nextState.block.txs[0], coinbaseExcludes, customTransactionColumn))
